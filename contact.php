...
<body class="rest">
  <div class="topnav" id="myTopnav">
    ...
    <i class="fa fa-bars"></i></a>
      ...
      <div style="text-align: center;margin-top:30px;font-size: 35px; font-family:Georgia, 'Times New Roman', Times, serif;"><STRong> WELCOME TO TSF BANK</STRong></div>
      <br>
      <div style="text-align:center; font-size: 20px;">
          For further informtion please contact   <a href="https://www.thesparksfoundationsingapore.org/" target="_blank">THE SPARKS FOUNDATION</a>
      </div>
